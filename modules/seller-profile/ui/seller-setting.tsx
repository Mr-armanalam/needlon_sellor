        ...
        <div className="md:col-span-2 bg-white border border-gray-100 rounded-2xl p-5 shadow-xs space-y-4">
          ...
          <div className="flex justify-end pt-2">
            <button
              ...
              onClick={save}
              disabled={isSaving}
              className={` ${isSaving ? 'bg-blue-100' : 'bg-blue-600'}  hover:bg-blue-700 text-white font-bold text-xs py-2.5 px-6 rounded-xl shadow-xs transition-all shadow-blue-600/10`}
            >
              {isSaving ? 'Configurating...' : 'Apply Configurations'}
            </button>
          </div>
        </div>
      </div>
