...
import {SellerBankAccountDto, SellerBankDto} from "@/modules/seller-profile/dto";
import {SaveStatus} from "@/modules/seller-profile/view/seller-foundation-page";
import {useSellerBank, useSetPrimaryBankAccount} from "@/modules/seller-profile/hooks";
import {useDeleteBankUpi} from "@/modules/seller-profile/hooks/use-delete-bank-upi";
import {BankAccountSkeleton, EmptyBankState} from "@/modules/seller-profile/components";
import {PayoutDrawerForm} from "@/modules/seller-profile/ui/bank-upi-sheet";


type props = {
    setEditing: (Dispatch<SetStateAction<SellerBankAccountDto | undefined>>);
    setOpen: (Dispatch<SetStateAction<boolean>>);
    setDeleting: (Dispatch<SetStateAction<string | undefined>>);
    setSaveStatus: React.Dispatch<React.SetStateAction<SaveStatus>>;
    triggerDrawer: (contentNode: React.ReactNode) => void;
    editing: SellerBankAccountDto | undefined;
}

const BankUpiCards = ({setOpen, setDeleting, editing, triggerDrawer, setSaveStatus, setEditing} : props) => {

    const {
        data,
        isLoading,
    } = useSellerBank();
    const primary = useSetPrimaryBankAccount();
