...
export class OrderTransformer {
    static toItemLineDto(item: OrderItemDomain): OrderListItemLineDto {
        return {
            id: item.id,
    ...
    static toListItemDto(order: OrderDomain): OrderListItemDto {
        return {
            id: order.id,
            ...
            items: order.items ? order.items.map(OrderTransformer.toItemLineDto) : [],
        };
    }

    static toDetailResponse(order: OrderDomain): OrderDetailResponseDto {
        const base = OrderTransformer.toListItemDto(order);
